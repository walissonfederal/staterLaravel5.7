                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox"
                                           name="lessor" {{ (old('lessor') == 'on' || old('lessor') == true ? 'checked' : ($user->lessor == 1 ? 'checked' : '' )) }}><span>Locatário</span>
                                </label>

                                <label class="label">
                                    <input type="checkbox"
                                           name="lessee" {{ (old('lessee') == 'on' || old('lessee') == true ? 'checked' : ($user->lessee == 1 ? 'checked' : '' )) }}><span>Locador</span>
                                </label>
                            </div>
                            ...
                            <div class="app_collapse mt-2">
                                ...
                                <div class="app_collapse_content d-none">
                                    ...
                                    <label class="label">
                                        ...
                                        <input type="text" name="company_work" placeholder="Empresa"
                        ...
                        <div id="complementary" class="d-none">
                            <div class="app_collapse">
                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        <span class="legend">Empresa:</span>
                                        <input type="text" name="spouse_company_work" placeholder="Empresa"
